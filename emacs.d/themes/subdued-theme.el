...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#000" :foreground "#eeeee0"))))
 '(mouse ((t (:foregound "#000080"))))
 '(cursor ((t (:foregound "#000080"))))
 '(border ((t (:foregound "#0f0f0f"))))

 '(font-lock-comment-face ((t (:foreground "#61636e")))) ; dark aluminum
 '(font-lock-comment-delimiter-face ((t (:foreground "#61635e")))) ; dark aluminum
 '(font-lock-doc-face ((t (:foreground "#859900")))) ; green
 '(font-lock-doc-string-face ((t (:foreground "#859900")))) ; green
 '(font-lock-string-face ((t (:foreground "#859900")))) ; green
 '(font-lock-keyword-face ((t (:foreground "#2aa198")))) ; light sky blue
 '(font-lock-builtin-face ((t (:foreground "#8b2c02")))) ; chocolate
 '(font-lock-function-name-face ((t (:foreground "#dc322f")))) ; red
 '(font-lock-variable-name-face ((t (nil))))
 '(font-lock-preprocessor-face ((t (:foreground "#888a85")))) ; aluminum
 '(font-lock-constant-face ((t (:foreground "#546e00")))) ; dark chameleon
 '(font-lock-type-face ((t (:foreground "#268bd2")))) ; blue
